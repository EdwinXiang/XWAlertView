...
- (void)setupLabel {
    ...
    [self.detailLabel setTextColor:TITLE_COLOR];
...
- (void)setupButton {
    ...
    if (self.cancelButtonTitle != nil) {
        ...
        [self.cancelButton setBackgroundImage:[UIImage imageNamed:@"unclickW"] forState:UIControlStateNormal];
        [self.cancelButton setBackgroundImage:[UIImage imageNamed:@"unClick"] forState:UIControlStateHighlighted];
    ...
    if (self.otherButtonTitles != nil) {
        ...
        for (NSString *title in self.otherButtonTitles) {
            ...
            [button setBackgroundImage:[UIImage imageNamed:@"unclickW"] forState:UIControlStateNormal];
            [button setBackgroundImage:[UIImage imageNamed:@"unClick"] forState:UIControlStateHighlighted];
            [button addTarget:self action:@selector(buttonTouch:) forControlEvents:UIControlEventTouchUpInside];
            [[button layer] setCornerRadius:5.0];
            [[button layer] setMasksToBounds:YES];
            [[button layer] setBorderWidth:1.0];
            [[button layer] setBorderColor:ERROR_COLOR.CGColor];
